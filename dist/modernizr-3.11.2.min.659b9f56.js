...
!function (e, t, n, r) {
  ...
  function i(e) {
    ...
    if (S && (t = t.baseVal), Modernizr._config.enableJSClass) {
      var _r = new RegExp('(^|\\s)' + n + 'no-js(\\s|$)');
      t = t.replace(_r, '$1' + n + 'js$2');
    }
    Modernizr._config.enableClasses && (e.length > 0 && (t += ' ' + n + e.join(' ' + n)), S ? _.className.baseVal = t : _.className = t);
  }
  function s(e, t) {
    if (_typeof(e) === 'object') for (var _n in e) {
      k(e, _n) && s(_n, e[_n]);
    } else {
      e = e.toLowerCase();
      var _r2 = e.split('.');
      var _o = Modernizr[_r2[0]];
      if (_r2.length === 2 && (_o = _o[_r2[1]]), void 0 !== _o) return Modernizr;
      t = typeof t === 'function' ? t() : t, _r2.length === 1 ? Modernizr[_r2[0]] = t : (!Modernizr[_r2[0]] || Modernizr[_r2[0]] instanceof Boolean || (Modernizr[_r2[0]] = new Boolean(Modernizr[_r2[0]])), Modernizr[_r2[0]][_r2[1]] = t), i([(t && !1 !== t ? '' : 'no-') + _r2.join('-')]), Modernizr._trigger(e, t);
    }
    return Modernizr;
  }
  function a() {
  ...
  function f(e, n, r) {
    ...
    if ('getComputedStyle' in t) {
      ...
      var _i = t.console;
      if (o !== null) r && (o = o.getPropertyValue(r));else if (_i) {
        var _s = _i.error ? 'error' : 'log';
        _i[_s].call(_i, 'getComputedStyle returning null, its possible modernizr test results are inaccurate');
      }
  ...
  function v(e, t, n) {
    var r;
    for (var _i2 in e) {
      if (e[_i2] in t) return !1 === n ? e[_i2] : (r = t[e[_i2]], o(r, 'function') ? A(r, n || t) : r);
    }
    return !1;
  }
  function g(e, t, n, r, i) {
    var s = e.charAt(0).toUpperCase() + e.slice(1);
    var a = (e + ' ' + O.join(s + ' ') + s).split(' ');
  ...
  C._domPrefixesAll = R, Modernizr.addTest('pointerevents', function () {
    for (var _e = 0, _t = R.length; _e < _t; _e++) {
      if (E(R[_e] + 'pointerdown')) return !0;
    }
    return !1;
  });
  var j = !0;
  ...
  Modernizr.addTest('websockets', M), Modernizr.addTest('cssanimations', y('animationName', 'a', !0)), function () {
    ...
    var e, t, n, r, i, s, a;
    for (var _l2 in w) {
      if (w.hasOwnProperty(_l2)) {
        if (e = [], t = w[_l2], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "52205" + '/');
